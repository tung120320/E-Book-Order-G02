...
values 
('tung','thanh','abc','abc@gmail.com','4389768587','9999999'),
...
select it.itemId, it.itemName, it.itemPrice from orders ord inner join orderDetails ordt on ord.orderId = ordt.orderId inner join Items it on ordt.itemId = it.itemId where ord.orderUser = 1 ;
