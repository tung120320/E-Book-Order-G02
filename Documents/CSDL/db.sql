...
insert into Items(itemName,itemPrice,itemStar,itemAuthor,itemCategory,itemDescription,itemISBN,temPublished,itemPublisher,itemLanguage,itemPages)
values(' Learning Bootstrap 4 by Building Projects','$34.99 - $60.66','2','Eduonix Learning Solutions','Bootstrap','Bootstrap, the world`s most popular frontend framework, is an open source toolkit for building web applications with HTML, CSS, and JavaScript.
...
By the end of this book, you will have built websites that are visually appealing, responsive, and robust.','1789343259','2018','Packt Publishing','English','218'),
(' Machine Learning and AI for Healthcare','$30.17 - $35.99','4','Arjun Panesar','Big Data','Explore the theory and practical applications of artificial intelligence (AI) and machine learning in healthcare. This book offers a guided tour of machine learning algorithms, architecture design, and applications of learning in healthcare and big data challenges.
...
Gain a deeper understanding of key machine learning algorithms and their use and implementation within wider healthcare; Implement machine learning systems, such as speech recognition and enhanced deep learning/AI; Select learning methods/algorithms and tuning for use in healthcare; Recognize and prepare for the future of artificial intelligence in healthcare through best practices, feedback loops and intelligent agents.','1484237986','2019','Apress','English','368'),
(' Arduino Applied','$27.75 - $31.49','3','	Neil Cameron','Arduino','Extend the range of your Arduino skills, incorporate the new developments in both hardware and software, and understand how the electronic applications function in everyday life. This project-based book extends the Arduino Uno starter kits and increases knowledge of microcontrollers in electronic applications.
...
Set up the Arduino Uno and its programming environment; Understand the application of electronics in every day systems; Build projects with a microcontroller and readily available electronic components.','1484239598','2019','Apress','English','552'),
('C++ Concurrency in Action, 2nd Edition','$39.99 - $66.21','4','Anthony Williams','C++','This bestseller has been updated and revised to cover all the latest changes to C++ 14 and 17! C++ Concurrency in Action, 2nd Edition teaches you everything you need to write robust and elegant multithreaded applications in C++17.
...
Install and configure peripherals, software packages, and keep everything current; Connect to the internet, set up a local area network (including a primer on TCP/IP, and managing a local area network using configuration tools and files); Browse the web securely and anonymously; Get everything you need to pass your entry-level Linux certification exams.','1119490464','2018','Wiley','English','560'),
('Người Đầu Tiên Trong Danh Sách','78.400 ₫','3','Magdalena Witkiewicz','Văn học','MagdalenaWitkiewicz- tác giả các cuốn sách đã in tại Nhà xuất bản Trẻ: Trường học dành cho các bà vợ, Lâu đài cát… hiện vẫn đang là tác giả có sách bán chạy nhất của văn học Ba Lan hiện đại.

Tác phẩm mới của chị - Người Đầu Tiên Trong Danh Sách - là một tác phẩm ấm áp, xúc động về tình yêu, tình bạn.

Thông điệp của tác phẩm: Không bao giờ là quá muộn để thay đổi một điều gì đó trong cuộc sống. Tình cảm thiêng liêng sẽ đưa con người vượt qua mọi lốc xoáy của số phận "Bạn không thể thay đổi quá khứ, nhưng bạn vẫn còn cơ hội để thay đổi tương lai…"','2519716806120','10-2016','Nhà Xuất Bản Trẻ','Tiếng Việt','360'),
